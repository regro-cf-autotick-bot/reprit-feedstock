...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/reprit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11282&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/reprit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `reprit` can be installed with:

```
conda install reprit
```

It is possible to list all of the versions of `reprit` available on your platform with:
